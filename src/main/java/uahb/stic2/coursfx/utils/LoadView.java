...
public class LoadView
{
	...
	{
		if(type == 1){
			root=FXMLLoader.load(LoadView.class.getResource("/uahb/stic2/coursfx/view/"+name)); //load a simple view
			scene=new Scene(root);
		}
		else if(type == 2) // load borderpane
		{
			rootBorder=FXMLLoader.load(LoadView.class.getResource("/uahb/stic2/coursfx/view/"+name));
